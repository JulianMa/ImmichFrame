...
| Image                   | PreloadNeighbors           | boolean                             | false                                          | Keep next/previous images mounted hidden so the browser pre-decodes them — avoids black flash on low-end hardware. Uses extra memory. |
